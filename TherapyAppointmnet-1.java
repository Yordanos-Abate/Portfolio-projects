//This application is how patients of a psychologist make an appointment.
...
public class TherapyAppointmnet  extends JFrame implements ActionListener {
  ...
  public void actionPerformed(ActionEvent event){
    String URL = "jdbc:mysql://localhost/therapyapp?user=root&password=";
...
String insert_add = "insert into patient (lastname, firstname, app_date, app_time, insurance) values ('"+lastname+"', '"+firstname+"', '"+date+"', '"+time+"', '"+insurance+"')";
      ...
      File therapyfile = new File("therapy.text");
      FileWriter writer = new FileWriter(therapyfile);
      writer.write("Appointmnet has been scheduled\n");
      writer.write(info);
      writer.close();
    }
    ...
    if (event.getSource() == cancelButton){
      ...
      appdateTextField.setText("");
      streetTextField.setText("");
      cityTextField.setText("");
      zipTextField.setText("");
      phoneTextField.setText("");
      stateBox.setSelectedIndex(0);
      apptimeBox.setSelectedIndex(0);
      appsessionBox.setSelectedIndex(0);
